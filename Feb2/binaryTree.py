# This is the visualizer file.
# No changes should be made to this and instead
# should be imported and inherited for use in
# other trees.

# keep in mind the properties of the Node
# left, right, data, and height
...
class BinaryTree:
    ...
    def copy_tree(self):
        new_tree = BinaryTree()
        new_tree.head = self._copy_node(self.head)
        return new_tree
